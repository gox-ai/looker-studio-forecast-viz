...
class Complex {
  ...
  mult(other) {
    ...
    return new Complex(this._real * other._real - this._imag * other._imag, this._imag * other._real + this._real * other._imag);
  }
  ...
  div(other) {
    ...
    return new Complex((this._real * other._real + this._imag * other._imag) / d, (this._imag * other._real - this._real * other._imag) / d);
  }
  ...
  sqrt() {
    ...
    return [new Complex(Math.cos(th) * s, Math.sin(th) * s), new Complex(Math.cos(th + Math.PI) * s, Math.sin(th + Math.PI) * s)];
  }
  ...
  cbrt() {
    ...
    return [new Complex(Math.cos(th) * s, Math.sin(th) * s), new Complex(Math.cos(th + 2 * Math.PI / 3) * s, Math.sin(th + 2 * Math.PI / 3) * s), new Complex(Math.cos(th + 4 * Math.PI / 3) * s, Math.sin(th + 4 * Math.PI / 3) * s)];
  }
}
